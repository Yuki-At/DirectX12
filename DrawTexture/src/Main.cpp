...
HRESULT InitWindow() {
    ...
    hWindow = CreateWindow(
        WindowClassName, TEXT("DrawTexture - DirectX12"),
...
HRESULT InitDirectX() {
    ...
    // Swap Chain
    {
        ...
        desc.SwapEffect = DXGI_SWAP_EFFECT_FLIP_DISCARD; // DXGI_SWAP_EFFECT_DISCARD と間違えないように！！！
    ...
    // Root Signature
    {
        ...
        samplers[0].BorderColor = D3D12_STATIC_BORDER_COLOR_TRANSPARENT_BLACK; // ADDRESS_MODE(AddressU, etc.) が BORDER ではないので使用されない
